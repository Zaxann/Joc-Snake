...
class SNAKE:
    def __init__(self):
        ...
        self.crunch_sound = pygame.mixer.Sound('Sunet/crunch.wav')

    def update_head_imagine(self):
    ...
    def draw_snake(self):   
     self.update_head_imagine()
     self.update_tail_imagine()
...
clock = pygame.time.Clock() # Clock pt a nu se misca prea incet sau prea repede din cauza pc-ului
apple = pygame.image.load('Imagini/apple.png').convert_alpha()
game_font=pygame.font.Font('Font/Overthink.ttf',25)
...
#Loop Joc
while True:
    #Desenam toate elementele background,etc
    ...
    clock.tick(60) # Adica cum facem aici pt 60